  ...
  useEffect(() => {
    const loadDashboardData = () => {
      try {
        ...
        const pendingFees = fees.filter(f => f.status === 'pending' || f.status === 'partial').reduce((sum, fee) => sum + (fee.balanceDue || fee.amount), 0)
        ...
        const activities = [
          {
            ...
            description: 'Emma Wilson joined the system',
            time: '2 hours ago',
          ...
          },
          {
            ...
            description: 'Mathematics Midterm Exam created',
            time: '4 hours ago',
            color: 'text-blue-500'
          },
          {
            ...
            description: 'James Rodriguez paid tuition fee',
            time: '6 hours ago',
          ...
          },
          {
            ...
            description: 'Sarah Johnson marked attendance for Class 10A',
            time: '8 hours ago',
          ...
          },
          {
            ...
            icon: AlertCircle,
            title: 'Fee Reminder',
            description: '3 students have pending fees',
            time: '1 day ago',
            color: 'text-red-500'
          }
        ]
