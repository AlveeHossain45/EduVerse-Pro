    ...
    const loadDashboardData = () => {
      try {
        ...
        const mockClasses = [
          ...
          {
            id: 3,
            name: 'Mathematics 10A - Extra Session',
            time: '2:00 PM',
            room: 'Online',
            type: 'online',
            students: 15
        ...
        const activities = [
          {
            ...
            icon: FileText,
            title: 'Exam Created',
            description: 'Mathematics Midterm Exam scheduled',
            time: '2 hours ago',
            color: 'text-blue-500'
          },
          {
          ...
          },
          {
            ...
            description: 'New physics assignment uploaded',
            time: '6 hours ago',
